...
export default class DesktopLayout {
    ...
    getRootWidget(appContext) {
        ...
        return new RootContainer()
            ...
            .child(new StandardTopWidget().hideInZenMode())
            .child(
                new FlexContainer("row")
                    .collapsible()
                    .filling()
                        ...
                        new FlexContainer("column")
                            ...
                            .child(
                                new FlexContainer("row")
                                    ...
                                    .child(
                                        new NotePathsWidget().hideInZenMode()
                                    )
                                    .child(new NoteTypeWidget().hideInZenMode())
                                    .child(
                                        new NoteActionsWidget().hideInZenMode()
                                    )
                            )
                            .child(
                                new TabCachingWidget(() =>
                    ...
                    .child(
                        new SidePaneContainer("right")
                            ...
                            .child(
                                new TabCachingWidget(
                                    () => new NoteRevisionsWidget()
                                )
                            )
                            .child(
                                new TabCachingWidget(
                                    () => new WhatLinksHereWidget()
                                )
                            )
