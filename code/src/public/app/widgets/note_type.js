...
const NOTE_TYPES = [
    ...
    { type: "task", mime: "text/html", title: "Task", selectable: true },
    { type: "category", mime: "text/html", title: "Category", selectable: true },
    { type: "swimlane", mime: "text/html", title: "Swimlane", selectable: true },
    { type: "swimlane_dashboard", mime: "text/html", title: "Task Overview", selectable: true },
    ...
    { type: "bucket", mime: "text/html", title: "Main Bucket", selectable: true }
    { type: "code", mime: 'text/plain', title: "Code", selectable: true },
    { type: "bucket", mime: "text/html", title: "Main Bucket", selectable: true }
];
