...
import BucketWidget from "./bucket.js";
import BucketWidget from "./bucket.js";
import EmptyTypeWidget from "./type_widgets/empty.js";
import EditableTextTypeWidget from "./type_widgets/editable_text.js";
import ReadOnlyTaskTypeWidget from "./type_widgets/read_only_task.js"
import EditableTaskTypeWidget from "./type_widgets/editable_task.js"
import SwimlaneTypeWidget from "./type_widgets/swimlane.js";
import TaskOverviewTypeWidget from "./type_widgets/task_overview.js";
import ReadOnlyTaskTypeWidget from "./type_widgets/read_only_task.js"
import EditableTaskTypeWidget from "./type_widgets/editable_task.js"
import SwimlaneTypeWidget from "./type_widgets/swimlane.js";
import TaskOverviewTypeWidget from "./type_widgets/task_overview.js";
...
const typeWidgetClasses = {
    ...
    'readOnlyTask': ReadOnlyTaskTypeWidget,
    'editableTask': EditableTaskTypeWidget,
    'swimlane' : SwimlaneTypeWidget,
    'taskOverview' : TaskOverviewTypeWidget,
    'noteBucket' : BucketWidget,
    'readOnlyTask': ReadOnlyTaskTypeWidget,
    'editableTask': EditableTaskTypeWidget,
    'swimlane' : SwimlaneTypeWidget,
    'taskOverview' : TaskOverviewTypeWidget,
...
export default class NoteDetailWidget extends NoteContextAwareWidget {
    ...
    async getWidgetType() {
        ...
        if (type === 'text' && viewScope.viewMode === 'source') {
            ...
            let readOnly = await this.noteContext.isReadOnly();
            if (readOnly) {
                type = 'readOnlyTask';
            } else {
                type = 'editableTask';
            ...
            type = 'swimlane';
        } else if (type === 'swimlane_dashboard') {
            type = 'taskOverview';
        } else if (type === 'bucket') {
            type = 'noteBucket';
