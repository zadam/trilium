...
import TaskPriorityWidget from "../widgets/task_priority.js";
import TaskDeadlineWidget from "../widgets/task_deadline.js";
import TaskStatusWidget from "../widgets/task_status.js";
import TaskCommentsWidget from "../widgets/task_comments.js";
import TaskDescriptionWidget from "../widgets/task_description.js";
import TaskRelationsWidget from "../widgets/task_relations.js";
import ConditionalFlexContainer from "../widgets/containers/conditional_flex_container.js";
import TaskSwimlaneWidget from "../widgets/task_swimlane.js";
import CreateNewFollowUpButton from "../widgets/buttons/create_new_follow_up.js";
import NewTaskDialog from "../widgets/dialogs/new_task_dialog.js";
import MarkTaskAsDoneButton from "../widgets/buttons/mark_task_as_done_button.js";
...
export default class DesktopLayout {
    ...
    generateNoteWidget() {
        return new NoteWrapperWidget()
            ...
            .child(new ConditionalFlexContainer('row', (noteContext) => {
                return noteContext && noteContext.note && (noteContext.note.type == "task");
            }).class('title-row')
            .css("height", "50px")
            .css("min-height", "50px")
            .css('align-items', "center")
            .cssBlock('.title-row > * { margin: 5px; }')
                .child(new TaskPriorityWidget())
                .child(new TaskStatusWidget())
                .child(new TaskDeadlineWidget())
                .child(new TaskSwimlaneWidget()))
            .child(
                new RibbonContainer()
                    ...
                    .button(new CreateNewFollowUpButton())
                    .button(new MarkTaskAsDoneButton())
            ...
            .child(new ScrollingContainer()
                    .filling()
                    .child(new SqlTableSchemasWidget())
                    .child(new NoteDetailWidget())
                    .child(new TaskDescriptionWidget())
                    .child(new TaskRelationsWidget())
                    .child(new TaskCommentsWidget())
