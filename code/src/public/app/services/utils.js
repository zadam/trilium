...
function getTextWidth(text, parentElement = document.body) {
        ...
        const font = getCanvasFont(parentElement);
...
function localDateInFutureDays(numberOfDays) {
    return dayjs().add(numberOfDays, 'day').format('YYYY-MM-DD');
}
