...
const swimlaneService = require("./../../services/swimlanes")
function getNote(req) {
    return becca.getNoteOrThrow(req.params.noteId);
}

function getChildren(req) {
    return becca.getChildren(req.params.parentNoteId);
}
...
function createNote(req) {
    ...
    if (note.type === 'task') {
        taskService.generateMissingTaskAttrs(note);
    } else if (note.type === 'swimlane') {
        swimlaneService.generateMissingSwimlaneAttrs(note);
    } else if (note.type === 'swimlane_dashboard') {
        swimlaneService.generateMissingSwimlaneDashboardAttrs(note);
    }
...
function updateNoteData(req) {
    ...
    const res = noteService.updateNoteData(noteId, content);
